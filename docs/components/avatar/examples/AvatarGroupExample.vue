<template>
    <AvatarGroup>
        <Avatar hover />
        <Avatar hover text="T" variant="blue" />
        <Avatar hover variant="orange">R</Avatar>
        ...
        <Avatar text="+8" hover variant="stats" />
    </AvatarGroup>
</template>
<script setup>
	import { Avatar, AvatarGroup, setVariantClasses } from '../../../../src/index'
    setVariantClasses({
        'Avatar': {
            blue: {
